...
function masParticipativos() {
    ...
    $.getJSON('Integrantes/ParticipativoJSON', function(resp) {
        //console.log(resp);
        $.each(resp, function(i, item) {
            $("#participativos").append(' <li><span class="text-info">' + item.NOMBRES + '</span> <b class="text-warning" >(' + item.TOTAL + ') <i class="fa fa-calendar-plus-o" aria-hidden="true"></i></b>  </li>');
        });
    });
}
...
function menosParticipativos() {
    ...
    $.getJSON('Integrantes/MenosParticipativoJSON', function(resp) {
        console.log(resp);
        $.each(resp, function(i, item) {
            $("#NoParticipativos").append(' <li><span class="text-info">' + item.NOMBRES + '</span> <b class="text-warning" >(' + item.TOTAL + ')  <i class="fa fa-calendar-times-o" aria-hidden="true"></i>  </li>');
        });
    });
}
